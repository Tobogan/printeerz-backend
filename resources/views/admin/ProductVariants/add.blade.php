        ...
        <div class="col">
            ...
            <div class="mt-3" id="img_add_product">
                ...
                <!--~~~~~~~~~~~___________QTY__________~~~~~~~~~~~~-->
                    {!! Form::label('qty', 'Entrer la quantité : ') !!}
                    {!! Form::number('qty', 0, ['class' => 'form-control']) !!}

                <!--~~~~~~~~~~~_____________________~~~~~~~~~~~~-->
                <div class="form-group mb-2 mt-2">
                    {{Form::text('zone1', null, array('class'=>'form-control mt-4', 'placeholder' => 'Saisissez le nom de la zone n°1 : ', 'id'=>'zone1', 'name'=>'zone1'))}}
                    {!! Form::file('image1[]', array('class' => 'image_couleur form-control  mt-2', 'multiple' => true, 'id' => 'image_couleur')) !!}
                    
                    <!--~~~~~~~~~~~___________Gabarit1__________~~~~~~~~~~~~-->
                    {!! Form::select('gabarit1', ['1' => 'Gabarit 1', '2' => 'Gabarit 2', '3' => 'Gabarit 3', '4' => 'Gabarit 4',], null, ['class' => 'form-control mb-1 mt-1', 'placeholder' => 'Sélectionner le gabarit 1']) !!} 

                    <hr>
                    {{Form::text('zone2', null, array('class'=>'form-control mt-4', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone2', 'name'=>'zone2'))}}
                    {!! Form::file('image2[]', array('class' => 'image_couleur form-control  mt-2', 'id' => 'image2')) !!}
                    <!--~~~~~~~~~~~___________Gabarit1__________~~~~~~~~~~~~-->
                    {!! Form::select('gabarit2', ['1' => 'Gabarit 1', '2' => 'Gabarit 2', '3' => 'Gabarit 3', '4' => 'Gabarit 4',], null, ['class' => 'form-control mb-1 mt-1', 'placeholder' => 'Sélectionner le gabarit 2']) !!} 

                    <hr>
                    {{Form::text('zone3', null, array('class'=>'form-control mt-4', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone3', 'name'=>'zone3'))}}
                    {!! Form::file('image3[]', array('class' => 'image_couleur form-control  mt-2', 'id' => 'image3')) !!}
                    <!--~~~~~~~~~~~___________Gabarit1__________~~~~~~~~~~~~-->
                    {!! Form::select('gabarit3', ['1' => 'Gabarit 1', '2' => 'Gabarit 2', '3' => 'Gabarit 3', '4' => 'Gabarit 4',], null, ['class' => 'form-control mb-1 mt-1', 'placeholder' => 'Sélectionner le gabarit 3']) !!} 

                    <hr>
                    {{Form::text('zone4', null, array('class'=>'form-control mt-4', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone4', 'name'=>'zone4'))}}
                    {!! Form::file('image4[]', array('class' => 'image_couleur form-control  mt-2', 'id' => 'image4')) !!}
                    <!--~~~~~~~~~~~___________Gabarit1__________~~~~~~~~~~~~-->
                    {!! Form::select('gabarit4', ['1' => 'Gabarit 1', '2' => 'Gabarit 2', '3' => 'Gabarit 3', '4' => 'Gabarit 4',], null, ['class' => 'form-control mb-1 mt-1', 'placeholder' => 'Sélectionner le gabarit 4']) !!} 
