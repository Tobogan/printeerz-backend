        ...
        <div class="col">
            ...
            <div class="mt-3" id="img_add_product">
                ...
                <div class="form-group mb-2 mt-2">
                    ...
                    <hr>
                    {{Form::text('zone3', null, array('class'=>'form-control', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone3', 'name'=>'zone3'))}}
                    {!! Form::file('image3', array('class' => 'image_couleur form-control  mt-2', 'id' => 'image3')) !!}
                    <hr>
                    {{Form::text('zone4', null, array('class'=>'form-control', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone4', 'name'=>'zone4'))}}
                    {!! Form::file('image4', array('class' => 'image_couleur form-control  mt-2', 'id' => 'image4')) !!}
                    <hr>
                    {{Form::text('zone5', null, array('class'=>'form-control', 'placeholder' => 'Saisissez le nom de la zone n°2 : ', 'id'=>'zone5', 'name'=>'zone5'))}}
