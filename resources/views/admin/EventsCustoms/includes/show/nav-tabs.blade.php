...
<?php $i++; ?>
<li class="nav-item">
    <a class="nav-link" id="template_component_{{$component['events_component_id']}}-tab" data-toggle="tab"
        href="#template_component_{{$component['events_component_id']}}" role="tab"
