          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  {!! Form::date('end_datetime', $event->end_datetime, ['class' => 'form-control'. $errors->first('end_datetime', ' is-invalid'), 'placeholder' => 'Fin',
            ...
            <div class="form-group">
              ...
              <input class="form-control mt-2" id="formPlacesAuto" placeholder="Renseignez l'adresse"
                name="autocompleteAddress" type="text" autocomplete="false" onFocus="initMap();" value="{{ $event->location['address'].$event->location['city'] }}">
        ...
        <div class="row">
            <div class="col-12">
                  <div class="card">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            {!! Form::select('employees[]', App\User::pluck('username','_id'),$event->user_ids, ['class' => 'form-control'. $errors->first('employees', ' is-invalid'), 'multiple', 'data-toggle' => 'select']) !!}
                            {!! $errors->first('employees', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                          </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                      <div class="form-group">
                          ...
                          <small class="form-text text-muted">
                            ...
                            {!! $errors->first('logo_img', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                      </div>
                      <div class="form-group">
                          <label class="mb-1">
                          ...
                          <small class="form-text text-muted">
                            ...
                            {!! $errors->first('cover_img', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                      </div>
                      <div class="form-group">
                        <label class="mb-1">
                          BAT de l'événement
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            {!! Form::textarea('description', $event->description, ['id' => 'description', 'class' => 'form-control','rows' => 4, 'cols' => 54]) !!}
