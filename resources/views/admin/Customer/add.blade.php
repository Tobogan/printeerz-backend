                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! $errors->first('activity_type', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!} 
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('SIREN', null, ['class' => 'form-control', 'placeholder' => '012345678', 'data-mask' => '000000000' ]) !!}
                                        {!! $errors->first('SIREN', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    !!}
                                    {!! $errors->first('lastname', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! $errors->first('firstname', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                                </div>
                            </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! $errors->first('email', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        'Poste'])!!}
                                        {!! $errors->first('job_title', '<p class="help-block mt-2" style="color:red;"><small>:message</small></p>') !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-header-title mt-2">
                                Logo
                                <p class="text-muted mt-2">Ajoutez le logo du client de préférence en format 1:1 (format: jpeg,jpg,png | format: jpeg,jpg,png | max: 4mo)</p>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="col-12">
