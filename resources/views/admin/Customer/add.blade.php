                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Input -->
                                {!! Form::text('title', null, ['class' => 'form-control' . $errors->first('title', ' is-invalid'), 'placeholder' => 'Nom du client']) !!}
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Input -->
                                {!! Form::text('SIREN', null, ['class' => 'form-control'. $errors->first('SIREN', ' is-invalid'), 'placeholder' => '012345678', 'data-mask' => '000000000' ]) !!}
